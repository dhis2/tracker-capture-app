...
export function closeNaerkontaktEnrollment(tei, enrollmentService) {
    var naekontaktEnrollment = tei && tei.enrollments && tei.enrollments.find(enrollment => enrollment && enrollment.program === NEARKONTAKT_PROGRAM_ID && enrollment.status !== 'COMPLETED');
