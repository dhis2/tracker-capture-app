...
trackerCapture.controller('EnrollmentController',
        ...
        var setReportDateState = function(){
            if($scope.selectedProgram){
                ...
                var autoGeneratedStages = $scope.selectedProgram.programStages.filter(function(ps) { return ps.autoGenerateEvent });
                autoGeneratedStages.forEach(function(ps) {
                    var reportDateToUseLC = ps.reportDateToUse && ps.reportDateToUse.toLowerCase();
                    if(reportDateToUseLC === 'incidentdate' || !ps.generatedByEnrollmentDate){
                        $scope.incidentDateState.editable = false;
                    }else if(reportDateToUseLC ==='enrollmentdate' || ps.generatedByEnrollmentDate){
                        $scope.enrollmentDateState.editable = false;
                    }
                });
            }
