...
trackerCapture.controller('EnrollmentController',
        ...
        var setReportDateState = function(){
            if($scope.selectedProgram){
                ...
                var autoGeneratedStages = $scope.selectedProgram.programStages.filter(ps => ps.autoGenerateEvent);
                autoGeneratedStages.forEach(ps => {
                    var reportDateToUseLC = ps.reportDateToUse && ps.reportDateToUse.toLowerCase();
                    if(reportDateToUseLC === 'incidentdate'){
                        $scope.incidentDateState.editable = false;
                    }else if(!reportDateToUseLC || reportDateToUseLC ==='enrollmentdate'){
