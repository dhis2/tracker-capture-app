        ...
        $scope.search = function(searchGroup){
            if(!$scope.searching){
                ...
                if(currentSearchScope === searchScopes.PROGRAM){
                    ...
                    promise = SearchGroupService.programScopeSearch(searchGroup,tetSearchGroup, $scope.base.selectedProgramForSearch,$scope.trackedEntityTypes.selected, $scope.selectedOrgUnit, { skipTotalPages: true })
                }else{
